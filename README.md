...
{ "schema": 1,
  ...
  "devui": { "version": "1.2.12-remix.13", "asset": "u60pro-devui-aarch64" },
  "ui":    { "version": "0.4.10-remix.9", "asset": "ui.tar.gz" } }
```

在原版管理器中选择“自定义源链接”，正式发布后推荐填写对应版本的不可变 CDN 资产模板：

```text
https://fastly.jsdelivr.net/gh/scoltzero/u60pro-devui-remix@assets-v1.2.12-remix.13/{file}
```
